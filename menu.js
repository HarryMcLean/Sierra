...
function sumQuantities() {
    numBurgers = parseInt(document.getElementById('burgerq').value);
    numPizzas = parseInt(document.getElementById('pizzaq').value);
    numWraps = parseInt(document.getElementById('wrapq').value);
